...
export class ProductsComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ProductsComponent>, readonly snackBar: MatSnackBar, private giftboxsvc: HMService, public dialog: MatDialog, formBuilder: FormBuilder) {
